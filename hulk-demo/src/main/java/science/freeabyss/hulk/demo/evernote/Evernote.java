package science.freeabyss.hulk.demo.evernote;
...
public final class Evernote {
    ...
    public static void main(String[] args) {
        try {
            Evernote evernote = new Evernote(AUTH_TOKEN);
     ...
     */
    public Evernote(String token) throws TException, EDAMSystemException, EDAMUserException {
        // Set up the UserStore client and check that we can speak to the server
        EvernoteAuth evernoteAuth = new EvernoteAuth(EvernoteService.YINXIANG, token);
        ClientFactory factory = new ClientFactory(evernoteAuth);
        userStore = factory.createUserStoreClient();
        boolean versionOk = userStore.checkVersion("Evernote Demo (Java)",
    ...
    public List<Notebook> listNotebooks() throws TException, EDAMUserException, EDAMSystemException {
        ...
        for (Notebook book : evernotebooks) {
            ...
            System.out.println("create:" + DateUtil.dateStr(book.getServiceCreated()));
            System.out.println("update:" + DateUtil.dateStr(book.getServiceUpdated()));
